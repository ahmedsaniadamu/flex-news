...
@section('content')
<main class="sm:container sm:mx-auto sm:max-w-lg mb-5 sm:my-8">
    <div class="flex">
        <div class="w-full">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-6" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="name" type="text" class="form-input border border-gray-300 focus:shadow-none w-full @error('name')  border-red-500 @enderror"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="email" type="email"
                            class="form-input border border-gray-300 focus:shadow-none w-full @error('email') border-red-500 @enderror" name="email"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="password-confirm" type="password" class="form-input border border-gray-300 focus:shadow-none w-full"
